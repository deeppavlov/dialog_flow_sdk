...
flows = {
	...
	"greeting_flow": {
		...
		"greet_and_ask_about_pets": {
                TRANSITIONS: {'cool_and_clarify_which_pets': cnd.all([dm_cnd.is_sf("React.Respond.Support.Reply.Agree")]), 'sad_and_say_about_pets': cnd.all([dm_cnd.is_sf("React.Respond.Confront.Reply.Disagree")])},
                PROCESSING: {},
